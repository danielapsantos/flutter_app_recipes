...
void main() {
  ...
  setUp(() {
    ...
    // Limpar instâncias anteriores do GetIt
    getIt.reset();
  ...
  // Limpar instâncias após cada teste
  tearDown(() {
  ...
  group('AuthRepository', () {
    ...
    group('signUp', () {
  test('deve retornar UserProfile quando cadastro é bem-sucedido', () async {
    // Arrange
    final mockUser = User(
      id: 'user-id',
      appMetadata: {},
  ...
  test('deve retornar erro quando fetchUserProfile falha após signUp', () async {
    // Arrange
    final mockUser = User(
      id: 'user-id',
      appMetadata: {},
  ...
  test('deve retornar erro quando email não foi confirmado no signUp', () async {
    // Arrange
    when(mockAuthService.signUp(
      email: 'test@email.com',
      password: 'password123',
